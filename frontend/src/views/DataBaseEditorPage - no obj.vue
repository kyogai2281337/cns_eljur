<template>
    <header class="header container header__container">
      <h1 class="h1">Редактор баз данных</h1>
      ...
      <div class="header__workspace">
        <ul class="objects__list">
            <li class="objects__el objects__el-active "><button class="btn-no-bg text-gray">Кабинеты</button></li>
            <li class="objects__el"><button class="btn-no-bg text-gray">Преподаватели</button></li>
            <li class="objects__el"><button class="btn-no-bg text-gray">Группы</button></li>
            <li class="objects__el"><button class="btn-no-bg text-gray">Предметы</button></li>
            <li class="objects__el"><button class="btn-no-bg text-gray">Пользователи</button></li>
            <li class="objects__el"><button class="btn-no-bg text-gray">Роли</button></li>
        </ul>
        <button class="btn-no-bg">
          <svg width="16" height="15" viewBox="0 0 16 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2.40002 14.25L9.60002 7.5L2.40002 0.75" stroke="#A6A6A6" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
          </svg>            
        </button>
      </div>
    </header>
    ...
    <div class="bg"></div>
    <p class="text-hint36">
      Для начала работы выберите объект
    </p>
    </main>
</template>