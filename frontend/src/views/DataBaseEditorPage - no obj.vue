<template>
  <header class="header container header__container">
    ...
    <div class="header__workspace">
      <ul class="objects__list">
        ...
        <li class="objects__el">
          <button class="btn-no-bg text-gray">Пользователи</button>
        </li>
        <li class="objects__el">
          <button class="btn-no-bg text-gray">Роли</button>
        </li>
      </ul>
  ...
  <main class="main container main__container">
    <div class="bg"></div>
    <p class="text-hint36">Для начала работы выберите объект</p>
  </main>
</template>
