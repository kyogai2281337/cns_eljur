<template>
    <div class="bg"></div>
    <p class="text text-hint36">
        Выберите объект для начала работы
    </p>
    ...
    <header class="header container header__container">
        ...
        <div class="header__workspace">
            <ul class="objects__list">
                ...
                <li class="objects__el objects__el-selected"><button class="btn-no-bg text-gray">Преподаватели</button>
                </li>
