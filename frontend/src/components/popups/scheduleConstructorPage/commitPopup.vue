<template>
  <div class="popup popup-horisontal" id="createSchedulePopup">
    <div class="popup__header">
      <p class="h2 text text-warning">Создать расписание</p>
    ...
    <div class="popup__main">
      <form action="" class="form" id="createScheduleForm">
        <div class="form__element">
          <label for="getScheduleName" class="form__label"
            >Название нового расписания:</label
          >
          <input
            type="text"
            class="form__inp"
            id="getScheduleName"
            placeholder="Schedule_1"
            required
          />
        </div>
        <div class="form__element">
